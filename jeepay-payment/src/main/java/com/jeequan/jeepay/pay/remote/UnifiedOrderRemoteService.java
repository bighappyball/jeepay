 ...
 */
package com.jeequan.jeepay.pay.remote;
...
@Component
public class UnifiedOrderRemoteService extends AbstractPayOrderController implements UnifiedOrderService {
    ...
    public ApiRes unifiedOrder(UnifiedOrderParam unifiedOrderParam) {
        //获取参数 & 验签
        UnifiedOrderRQ rq = getRQByWithMchSign(unifiedOrderParam, UnifiedOrderRQ.class);
